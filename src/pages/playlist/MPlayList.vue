  ...
  <div class="m-play-list">
        ...
        <div class="func-area">
          <div class="button-group">
            <button @click.stop="playAll">
              <svg class="icon" fill="currentColor" height="16"
            ...
            <button @click.stop="appendEnd">
              <svg class="icon" fill="currentColor" height="15"
                   version="1.1" viewBox="0 0 1024 1024" width="15" xmlns="http://www.w3.org/2000/svg">
                <path
          ...
          <button :disabled="playlist?.subscribed" @click="handlerSubscribe">
            <svg class="icon" fill="currentColor" height="16" version="1.1"
          ...
          <button>
            <svg class="icon" fill="currentColor" height="16" version="1.1"
                 viewBox="0 0 1053 1024" width="16" xmlns="http://www.w3.org/2000/svg">
              <path
    ...
    <div class="tabs">
      <template v-for="item in tabs" :key="item.key">
        <div :class="item.active ? 'active' : ''" @click="handlerActive(item)">{{
            item.label
    ...
    <div class="tabs-content">
      <m-table v-if="tabs[0].active" :columns="columns" :data-source="dataSource" row-key="id"
               @row-double-click="handlerRowDbClick"/>
    </div>
  </div>
</template>
