<template>
  <div class="m-operate">
    <svg v-if="liked" class="icon liked" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
    ...
    <svg v-if="downloading" class="icon" :stroke-dasharray="strokeDasharray" width="20" height="20"
         viewbox="0 0 1024 1024">
      <circle cx="220" cy="220" r="170" stroke-width="50" stroke="blue" fill="none"></circle>
      <circle ref="downloadProgress" cx="220" cy="220" r="170" stroke-width="50" stroke="red" fill="none"
              transform="matrix(0,-1,1,0,0,440)" stroke-dasharray="0 1069"></circle>
    </svg>
    <svg v-else-if="downloaded" class="icon downloaded" viewBox="0 0 1024 1024" version="1.1"
